...
def matvec_identity__generate_crypto_context() -> ckks.CKKSContext:
  params = {
      ...
      "c": 128,
      "dnum": 3,
      "scaling_factor": 1073643521,
      "output_scale": 1073643521,
      "q_towers": [
          2147352577,
          1073184769,
          1073872897,
      ...
      "p_towers": [1073053697, 1072857089, 1072496641, 1071513601],
      "composite_degree": 1,
      "p": 30,
      "max_bits_in_word": 61,
...
def matvec_identity__configure_crypto_context(
  ...
  v0.program_initialization(
      total_rotation_indices=[1, 2, 3, 6], dnum=3, r=128, c=128, batch=1
  )
