!Z1071513601_i64 = !mod_arith.int<1071513601 : i64>
...
#modulus_chain_L5_C0 = #lwe.modulus_chain<elements = <2147352577 : i64, 1071513601 : i64, 1073872897 : i64, 1074266113 : i64, 1072496641 : i64, 1073479681 : i64>, current = 0>
#modulus_chain_L5_C1 = #lwe.modulus_chain<elements = <2147352577 : i64, 1071513601 : i64, 1073872897 : i64, 1074266113 : i64, 1072496641 : i64, 1073479681 : i64>, current = 1>
#modulus_chain_L5_C2 = #lwe.modulus_chain<elements = <2147352577 : i64, 1071513601 : i64, 1073872897 : i64, 1074266113 : i64, 1072496641 : i64, 1073479681 : i64>, current = 2>
#ring_f64_1_x8 = #polynomial.ring<coefficientType = f64, polynomialModulus = <1 + x**8>>
!rns_L0 = !rns.rns<!Z2147352577_i64>
!rns_L1 = !rns.rns<!Z2147352577_i64, !Z1071513601_i64>
!rns_L2 = !rns.rns<!Z2147352577_i64, !Z1071513601_i64, !Z1073872897_i64>
...
module attributes {scheme.ckks} {
  ...
  func.func @matvec_identity__generate_crypto_context() -> !jaxiteword.crypto_context<> {
    %0 = jaxiteword.gen_params  {batch = 1 : i32, c = 256 : i32, compositeDegree = 1 : i32, degree = 32768 : i64, dnum = 3 : i32, numSlots = 16384 : i64, pTowers = array<i64: 1070727169, 1069219841, 1068564481, 1068433409>, qTowers = array<i64: 2147352577, 1071513601, 1073872897, 1074266113, 1072496641, 1073479681>, r = 128 : i32, scalingFactor = 0x41D0000000000000 : f64} : () -> !jaxiteword.crypto_context<>
  ...
  func.func @matvec_identity__configure_crypto_context(%arg0: !jaxiteword.crypto_context<>, %arg1: !jaxiteword.public_key<>, %arg2: !jaxiteword.private_key<>, %arg3: !jaxiteword.eval_key<>) {
    jaxiteword.program_initialization %arg0, %arg1, %arg2, %arg3 {batch = 1 : i32, c = 256 : i32, dnum = 3 : i32, r = 128 : i32, totalRotationIndices = array<i64: 1, 2, 3, 6>} : (!jaxiteword.crypto_context<>, !jaxiteword.public_key<>, !jaxiteword.private_key<>, !jaxiteword.eval_key<>) -> ()
    return
  }
}
