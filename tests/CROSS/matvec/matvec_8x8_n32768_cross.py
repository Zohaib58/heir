...
def matvec_identity__generate_crypto_context() -> ckks.CKKSContext:
  params = {
      ...
      "c": 256,
      "dnum": 3,
      "scaling_factor": 1073479681,
      "output_scale": 1073479681,
      "q_towers": [
          2147352577,
          1071513601,
          1073872897,
      ...
      "p_towers": [1070727169, 1069219841, 1068564481, 1068433409],
      "composite_degree": 1,
      "p": 30,
      "max_bits_in_word": 61,
...
def matvec_identity__configure_crypto_context(
  ...
  v0.program_initialization(
      total_rotation_indices=[1, 2, 3, 6], dnum=3, r=128, c=256, batch=1
  )
