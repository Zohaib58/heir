!Z1073430529_i64 = !mod_arith.int<1073430529 : i64>
...
#modulus_chain_L5_C0 = #lwe.modulus_chain<elements = <2147352577 : i64, 1073430529 : i64, 1073872897 : i64, 1073479681 : i64, 1073643521 : i64, 1073692673 : i64>, current = 0>
#modulus_chain_L5_C1 = #lwe.modulus_chain<elements = <2147352577 : i64, 1073430529 : i64, 1073872897 : i64, 1073479681 : i64, 1073643521 : i64, 1073692673 : i64>, current = 1>
#modulus_chain_L5_C2 = #lwe.modulus_chain<elements = <2147352577 : i64, 1073430529 : i64, 1073872897 : i64, 1073479681 : i64, 1073643521 : i64, 1073692673 : i64>, current = 2>
#ring_f64_1_x8 = #polynomial.ring<coefficientType = f64, polynomialModulus = <1 + x**8>>
!rns_L0 = !rns.rns<!Z2147352577_i64>
!rns_L1 = !rns.rns<!Z2147352577_i64, !Z1073430529_i64>
!rns_L2 = !rns.rns<!Z2147352577_i64, !Z1073430529_i64, !Z1073872897_i64>
...
module attributes {scheme.ckks} {
  ...
  func.func @matvec_identity__generate_crypto_context() -> !jaxiteword.crypto_context<> {
    %0 = jaxiteword.gen_params  {batch = 1 : i32, c = 128 : i32, compositeDegree = 1 : i32, degree = 8192 : i64, dnum = 3 : i32, numSlots = 4096 : i64, pTowers = array<i64: 1073299457, 1073233921, 1073184769, 1073135617>, qTowers = array<i64: 2147352577, 1073430529, 1073872897, 1073479681, 1073643521, 1073692673>, r = 64 : i32, scalingFactor = 0x41D0000000000000 : f64} : () -> !jaxiteword.crypto_context<>
  ...
  func.func @matvec_identity__configure_crypto_context(%arg0: !jaxiteword.crypto_context<>, %arg1: !jaxiteword.public_key<>, %arg2: !jaxiteword.private_key<>, %arg3: !jaxiteword.eval_key<>) {
    jaxiteword.program_initialization %arg0, %arg1, %arg2, %arg3 {batch = 1 : i32, c = 128 : i32, dnum = 3 : i32, r = 64 : i32, totalRotationIndices = array<i64: 1, 2, 3, 6>} : (!jaxiteword.crypto_context<>, !jaxiteword.public_key<>, !jaxiteword.private_key<>, !jaxiteword.eval_key<>) -> ()
    return
  }
}
